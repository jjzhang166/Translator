...
static const yytype_uint16 yyrline[] =
{
     ...
     212,   218,   224,   248,   263,   265,   267,   269,   271,   273,
     275,   304,   310,   335,   343,   351,   354,   359,   381,   387,
     393,   398,   411,   417,   423,   429,   437,   445,   453,   462,
     470,   478,   486,   497,   504,   513,   518,   525,   566,   572,
     578,   584,   604,   611,   615,   625,   627,   632,   641,   649,
     657,   666,   675,   681,   695,   700,   711,   717,   724,   765,
     791,   799,   807,   816,   821,   827,   850,   858,   862,   868,
     874,   895,   899,   903,   908,   914,   925,   929
};
#endif
...
yyreduce:
  ...
  case 68:

    {
		...
		(yyval._node) = createNode(new OperatorAstNode((yyvsp[(1) - (2)]._node)->ptNode->text, (yyvsp[(2) - (2)]._node)->astNode, nullptr, new BoolType()), 
